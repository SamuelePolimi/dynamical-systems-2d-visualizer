...
visualizer.gif_trajectories(-2 * jnp.pi, 2 * jnp.pi, -8, 8, time=10., filename="global", title="Global Dynamics",
                            equilibrium=jnp.array([theta_d, 0]))
plt.show()

visualizer.gif_trajectories(theta_d - 0.05, theta_d + 0.05, -0.05, +0.05, time=10., filename="local",
...
plt.savefig("gif/eigenvectors.png")
plt.show()